(() => {
  ...
  buttons.forEach(btn => btn.addEventListener('click', ()=>{
    ...
    if(r>0){ you++; youEl.textContent=you; statusEl.textContent=`Você jogou ${me} e a Klein Dream jogou ${bot}. Você venceu!`; if (window.KDGameRanking) window.KDGameRanking.submitScore('rps', you); }
